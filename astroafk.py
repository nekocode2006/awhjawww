...
class AstroAfkMod(loader.Module):
    ...
    strings = {
        "name": "Modele [AstroAFK]",

        "lname": "| afk.",

        "bt_off_afk": "🚫 <b>AFK</b> режим <b>отключен</b>!",
    ...
    async def goafk(self, message):
        ...
        m = await utils.answer(message,
                               '<emoji document_id=5188391205909569136>✅</emoji> <b>АФК</b> режим был успешно <b>включен</b>!')
    ...
    async def ungoafk(self, message):
        ...
        m = await utils.answer(message,
                               '<emoji document_id=5465665476971471368>❌</emoji> <b>АФК</b> режим был успешно <b>выключен</b>!')
